...
public class CommentHibernateDaoTest {
    ...
    public void testGetCommentsLastPage(){
        ...
        Assert.assertEquals(ID.longValue(),ans.get(0).getId().longValue());
        ...
        Assert.assertEquals(LocalDateTime.of(2025,11,16,22,4,1),ans.get(0).getCreatedAt());
    }
    ...
    public void testGetCommentsFullPage(){
        ...
        for (int i = 0; i < COMMENTS_PAGE_SIZE; i++) {
            long commentId = ID + COMMENTS_PAGE_SIZE - i;
            Assert.assertEquals(commentId, ans.get(i).getId().longValue());
            ...
            Assert.assertEquals(LocalDateTime.of(2025,11,16,22,4,(int) (commentId - ID + 1)),ans.get(i).getCreatedAt());
        }
    }
